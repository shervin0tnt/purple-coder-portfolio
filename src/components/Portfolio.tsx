        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 max-w-6xl mx-auto">
          {projects.map((project, index) => (
            ...
            >
              ...
              <div
                className={`h-40 md:h-48 bg-gradient-to-br ${project.gradient} relative overflow-hidden`}
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-5xl md:text-6xl font-bold text-white/10 font-mono">
                    {index + 1}
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 md:p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tech.map((tech) => (
                    <span
                      key={tech}
                      className="px-3 py-1 text-xs md:text-sm bg-primary/10 text-primary rounded-full border border-primary/20 font-mono"
                    >
                      {tech}
                    </span>
                  ))}
